            ...
            Column(
              children: [
                ...
                Container(
                  ...
                  color: Colors.grey[200],
                  child: Wrap(
                    alignment: WrapAlignment.center, // Widgetの配置方法
                    direction:Axis.vertical , // horizontalが横方向。verticalが縦方向。デフォはhorizontal
                    runSpacing: 20.0, // 改行した行列のスペース。
                    spacing: 10.0, // 各行列内のアイテム間のスペース
                    children: [
                      // 並べるWidgetたち
                      Container(
                        margin: EdgeInsets.all(10),
